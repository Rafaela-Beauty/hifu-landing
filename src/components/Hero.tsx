...
export function Hero({ ctaHref }: HeroProps) {
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-white via-beige-warm/30 to-beige-light/20 py-16 sm:py-24">
      <div className="mx-auto flex max-w-5xl flex-col gap-8 px-6 text-center sm:text-left">
        ...
        <h1 className="font-display text-4xl font-bold leading-tight text-slate-900 sm:text-5xl lg:text-6xl">
          Rejuvenecé tu piel sin cirugía — HIFU profesional con Rafaela Beauty
        </h1>
        ...
        <div>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center justify-center rounded-full bg-sage-dark px-10 py-4 text-base font-semibold text-white shadow-lg shadow-sage-primary/25 transition hover:bg-sage-primary hover:shadow-xl hover:shadow-sage-primary/30 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-sage-dark"

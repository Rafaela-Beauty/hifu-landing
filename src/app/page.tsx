...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-linear-to-br from-white to-beige-warm px-6 py-16 text-center text-slate-800">
      ...
      <Link
        href="/hifu"
        className="mt-8 inline-flex items-center justify-center rounded-full bg-sage-dark px-10 py-4 text-base font-semibold text-white shadow-lg shadow-sage-primary/30 transition hover:bg-sage-primary hover:shadow-xl hover:shadow-sage-primary/40 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-sage-dark"

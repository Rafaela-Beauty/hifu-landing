...
export function CTA({ ctaHref }: CTAProps) {
  return (
    <section className="bg-gradient-to-br from-sage-dark to-sage-primary py-20 sm:py-28">
      <div className="mx-auto flex max-w-4xl flex-col items-center gap-6 px-6 text-center text-white">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center justify-center rounded-full bg-white px-10 py-4 text-base font-semibold text-sage-dark shadow-2xl transition hover:bg-beige-warm hover:shadow-2xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"

  ...
  return (
    <section className="relative bg-white py-14 sm:py-16">
      <div className="mx-auto max-w-4xl px-6">
        <div className="relative flex flex-col gap-6 rounded-3xl border-4 border-sage-dark bg-linear-to-br from-beige-warm to-beige-light px-8 py-12 text-center shadow-2xl shadow-sage-primary/20 sm:px-12">
          ...
          <ul className="space-y-3 text-left text-base leading-relaxed text-slate-800">
            <li className="flex items-start gap-3">
              <span className="mt-1 inline-block h-2 w-2 shrink-0 rounded-full bg-sage-dark"></span>
          ...
          <div>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center rounded-full bg-sage-dark px-10 py-4 text-base font-semibold text-white shadow-lg shadow-sage-dark/30 transition hover:bg-sage-primary hover:shadow-xl hover:shadow-sage-primary/40 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sage-dark"
